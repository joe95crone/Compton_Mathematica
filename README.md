...
[28/01/2022] An updated (ALEX VERSION) of the round beam optimisation code (RB_Compton_Optimisation.nb). No changes.

[28/01/2022] An updated (ALEX VERSION) of the non-round beam simplex optimisation code (Simplex_2D_Optimisation.nb). No changes. Code struggles at very small emittances and high energy spreads - becomes trapped in local minima.
